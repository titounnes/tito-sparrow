...
#define ZEPHIR_CONCAT_VSVVV(result, op1, op2, op3, op4, op5) \
	 zephir_concat_vsvvv(result, op1, op2, sizeof(op2)-1, op3, op4, op5, 0);
#define ZEPHIR_SCONCAT_VSVVV(result, op1, op2, op3, op4, op5) \
	 zephir_concat_vsvvv(result, op1, op2, sizeof(op2)-1, op3, op4, op5, 1);
...
void zephir_concat_vsvvv(zval *result, zval *op1, const char *op2, zend_uint op2_len, zval *op3, zval *op4, zval *op5, int self_var);
